...
const HeroSection = () => {
  return (
    <div id="home" className="h-[32rem] w-full md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
